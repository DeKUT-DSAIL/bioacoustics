...
To access the Raspberry Pi via SSH, follow the instructions outlined [here](https://github.com/DeKUT-DSAIL/bioacoustics/tree/master/setting-up-a-headless-raspberry/ssh-into-raspberry-pi).
